...
from Class.Bot.JumpBot import *
import threading
import time
from Class.Menu.BasicMenu import *


class JumpBotMenu(BasicMenu):
    __bot = JumpBot()
    ...
    def _run_bot(self):
        self.__bot.run()
        t = threading.Thread(target=self.__bot.jump, name='thread1')
